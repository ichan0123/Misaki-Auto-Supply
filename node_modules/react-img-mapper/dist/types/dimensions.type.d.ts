import type { Dimension, ImageMapperProps, Refs, WidthHeight } from "./";
...
type GetDimensionValuesParams = GetPropDimensionParams & Pick<Required<ImageMapperProps>, 'responsive' | 'parentWidth' | 'natural'>;
export type GetDimensionValues = (type: 'width' | 'height', params: GetDimensionValuesParams) => number;
