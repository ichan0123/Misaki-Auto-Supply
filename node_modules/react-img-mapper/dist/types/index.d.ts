import type { ConditionalKeys, NoUndefinedField } from "./lib.type";
...
type RequiredArea<T extends MapArea = MapArea, R extends keyof T = RequiredMapArea> = Omit<T, R> & Pick<NoUndefinedField<T>, R>;
...
export type ImgProps = Omit<HTMLProps<HTMLImageElement>, 'ref' | 'src' | 'useMap' | 'onClick' | 'onMouseMove'> | null;
...
export type AreaProps = Omit<HTMLProps<HTMLAreaElement>, 'key' | 'coords' | 'onMouseEnter' | 'onMouseLeave' | 'onMouseMove' | 'onMouseDown' | 'onMouseUp' | 'onTouchStart' | 'onTouchEnd' | 'onClick'> | null;
